...
import {webSocket} from '../../webSockets/consts';
...
import {speechListenButtonHandler} from '../../speech/listen/logic';
import {listenElements} from '../../speech/listen/uiElements';
...
function startChatRoom({token, sendMessageElements, settingsModalElements, signOutElements, messagesList}: StartChatRoom) {
	...
	listenElements.listMessages?.addEventListener('click', speechListenButtonHandler);
